...
def calculate_demographic_data(print_data=True):
    ...
    db = df[['native-country', 'occupation','salary']]
  
    db = db.loc[db['salary'] == '>50K']
  
    india = db.loc[db['native-country'] == 'India']
  
    top_one = india.occupation.describe()
  
    top_IN_occupation = top_one.top
